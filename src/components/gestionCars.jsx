...
function Gestion_cars() {
    ...
    const afficherDetailsClient = (client) => {
        const statutIcon = client.statut.toLowerCase() === "valid" ? "✅" : "⚠️";
        Swal.fire({
            ...
            html: `
                <div style="display: flex; flex-direction: column; align-items: center; gap: 15px;">
                    ...
                    <p style="margin: 8px 0; color: #374151;"><strong>statut: 
                        <span style="color: ${client.statut.toLowerCase() === 'valid' ? '#188236' : '#d33'}">
                ...
                <div>
                    ...
                    <div className="h-32 overflow-y-auto shadow-lg rounded-lg">
                        {list_clientF.map((c, i)=>
                            <div key={i} onClick={()=>setClient_id(c.id)} className={client_id === c.id ? 'bg-green-300 hover:bg-green-300 hover:cursor-pointer' : ' hover:bg-gray-100 hover:cursor-pointer'}>
